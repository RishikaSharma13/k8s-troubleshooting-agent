...
import type { Diagnosis, HistoryRow, InvestigationResponse } from "../types/investigation";
...
export default function Home() {
  ...
  const investigate = async () => {
    ...
    try {
      ...
      const response = await fetch(`${apiBase}/investigate`, { method: "POST", headers: { "Content-Type": "application/json" } });
